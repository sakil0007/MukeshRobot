...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="🏡𝐎𝐅𝐅𝐈𝐂𝐄🏡", url=f"https://t.me/YO_UR_OFFICIAL_CRUSH"),
    ],
    [
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            x=update.effective_message.reply_sticker(
                "NjAyNDIxMjYyMzo6OmQxOWI1NDAxNDBmOWE4MTYzNDU3YWUxOGE0ZWU0ZGQ2")
            x.delete()
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="📍𝐎𝐖𝐍𝐄𝐑📍", url=f"https://t.me/YO_UR_OFFICIAL_CRUSH"
                        ),
                        InlineKeyboardButton(
                            text="🎄𝐑𝐄𝐏𝐎🎄", 
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != {OWNER_ID} and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [𝚂𝙰𝙺𝙸𝙻](https://t.me/YO_UR_OFFICIAL_CRUSH)"
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="https://telegra.ph/file/c8510dc787aa503705ea1.jpg",
                caption=f"""
{dispatcher.bot.first_name}

╔═════ஜ۩۞۩ஜ═════╗

  ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [𝗦𝗔𝗞𝗜𝗟](https://t.me/YO_UR_OFFICIAL_CRUSH)♨️
